...
namespace MauticPlugin\LenonLeiteFilterValidEmailRecipientBundle\Command;
...
class CustomUpdateLeadListsCommand extends UpdateLeadListsCommand
{
    ...
    public function __construct(
        ...
        parent::__construct($listModel, $translator, $pathsHelper, $coreParametersHelper);
    }
